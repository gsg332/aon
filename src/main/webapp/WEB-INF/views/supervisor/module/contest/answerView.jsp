...
<div class="container">
	<div class="page-header">
		<h3><spring:message code="cts.lbl.052" /></h3>
	</div>
	<div class="info_box">
		<div class="info_view">
...
<!-- 				</div> -->
		...
		<div class="row">
			<div ng-show="{{item.status }} == 1000">
				...
				<div class="btnArea">
					<button ng-click="goAnswerList()" type="button"
		...
		<div ng-repeat="answer in answerList">
			<!-- 답변 -->
			<div class="info_view info_view_A" ng-if="answer.position == 1">
				<div class="info_top i_a">
					<div class="info_tbox">
						...
						<ul class="info_etc">
							...
							<li><span class="ie_date">{{answer.insertDate | Adate
									}}</span></li>
						</ul>
					</div>
				</div>
				...
				<div class="info_bottom">
					...
					<div class="info_score">
						<span class="head"><spring:message code="cts.lbl.033" /></span> <span
							class="grade">{{answer.gradePoint}}</span>
					</div>
				</div>
			</div>
			<!-- //답변 -->
			<!-- 추가질문 -->
			<div class="add_Q"
				ng-if="answer.position > 1 && answer.position % 2 == 0">
				<div class="info_top i_q">
					<div class="info_tbox">
						<strong class="info_tit"><spring:message
								code="cts.lbl.035" /></strong>
						<ul class="info_etc">
							<li><span class="name black">{{answer.registerUser.displayName}}</span></li>
							<li><span class="ie_date">{{answer.insertDate | Adate
									}}</span></li>
			...
			<!-- 추가답변 -->
			<div class="add_A"
				ng-if="answer.position > 1 && answer.position % 2 == 1">
				<div class="info_top i_a">
					<div class="info_tbox">
						<strong class="info_tit"><spring:message
								code="cts.lbl.036" /></strong>
						<ul class="info_etc">
							<li><span class="name black">{{answer.registerUser.displayName}}</span></li>
							<li><span class="ie_date">{{answer.insertDate | Adate
									}}</span></li>
