...
.config(function($routeProvider)
{
	$routeProvider.when('/', {
		...
		templateUrl : jcontext.getContextPath('/supervisor/module/contest/list.aon')
	}).when('/view/:id', {
		controller : 'ContestReadCtl',
		templateUrl : jcontext.getContextPath('/supervisor/module/contest/view.aon')
	}).when('/answerList/', {
...
.controller('ContestAnswerListCtl', function($scope, $rootScope, $httpParamSerializer) {
...
.controller('ContestReadCtl',function($scope, $http, $rootScope, $routeParams, $location, $route, safeApply) {
	$rootScope.leftMenu = 'contest';
