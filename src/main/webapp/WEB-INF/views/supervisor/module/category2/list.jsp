...
<div class="tree_box">
	<div class="tree_left" style="width: 20%;">
		<ul id="jstree" style="margin: 0;">
			<li ng-repeat="list in cateList" ng-click="cateLoad(list.id, $event)" style="cursor: pointer; margin-left: 10px;">{{list.name | ctgrLang}}</li>
		</ul>
	</div>
	<div class="tree_left" style="width: 43%;">
	...
	<div class="tree_right"  style="width: 30%;">
