...
@Controller
@RequestMapping(value = "/module/bankAccount/")
public class BankAccountUserController extends BaseController {

	private static final Logger logger = LoggerFactory.getLogger(BankAccountUserController.class);
